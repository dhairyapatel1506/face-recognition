...
imageRecognitionButton = Button(root, text="Image Recognition", command=image_recognition).place(relx=0.5, rely=0.5, anchor=CENTER)
webcamRecognitionButton = Button(root, text="Live Webcam Recognition", command=webcam_recognition).place(relx=0.8, rely=0.5, anchor=CENTER)
